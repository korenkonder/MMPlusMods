...
static void(FASTCALL* item_table_handler_array_get_item_objset)(::chara_index chara_index,
    ...
    = (void(FASTCALL*)(::chara_index chara_index,
        int32_t item_no, prj::list<int32_t>*& objset))0x00000001582FA4F0; // 0x00000001404E7590

HOOK(void, FASTCALL, TaskRobLoad__UnloadCharaItem, 0x0000000158003D10, // 0x00000001404E43A0
    ::chara_index chara_index, int32_t item_no, int32_t a3) {
    if (!item_no)
        return;
...
HOOK(void, FASTCALL, TaskRobLoad__LoadCharaItem, 0x0000000157FE7AC0, // 0x00000001404E4290
    ::chara_index chara_index, int32_t item_no, int32_t a3) {
    if (!item_no)
        return;
...
HOOK(bool, FASTCALL, TaskRobLoad__LoadCharaItemCheckNotRead, 0x00000001404E4300,
    ::chara_index chara_index, int32_t item_no, int32_t a3) {
    if (!item_no)
        return false;
...
HOOK(rob_chara_item_equip_object*, FASTCALL, rob_chara_item_equip_object__rob_chara_item_equip_object,
    0x0000000140590210, rob_chara_item_equip_object* This) {
...
HOOK(void, FASTCALL, rob_chara_item_equip_object_disp, 0x0000000140590810, rob_chara_item_equip_object* itm_eq_obj) {
...
HOOK(bool, FASTCALL, rob_chara_item_equip_object__init_members, 0x0000000159403130, // 0x0000000140590420
