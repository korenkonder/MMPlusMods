...
namespace Glitter {
    ...
    void EffectInstX::CalcDisp(render_data_context& rend_data_ctx) {
        render_scene.CalcDisp(rend_data_ctx);
    }
    ...
    void EffectInstX::Disp(render_data_context& rend_data_ctx, cam_data& cam, DispType disp_type, bool reflect) {
        render_scene.Disp(rend_data_ctx, cam, disp_type, reflect);
    }
