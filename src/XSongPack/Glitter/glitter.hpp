...
#define GPMX_VAL (glt_particle_manager_x)
    ...
    typedef prj::vector<prj::pair<int32_t, uint32_t>> DrawListData;
    ...
    struct RenderSceneX {
        ...
        void CalcDisp(render_data_context& rend_data_ctx, RenderGroupX* rend_group);
        void CalcDispLine(render_data_context& rend_data_ctx, RenderGroupX* rend_group);
        void CalcDispLocus(render_data_context& rend_data_ctx, RenderGroupX* rend_group);
        void CalcDispQuad(render_data_context& rend_data_ctx, RenderGroupX* rend_group);
        void CalcDispQuadDirectionRotation(render_data_context& rend_data_ctx,
            RenderGroupX* rend_group, mat4* model_mat);
        void CalcDispQuadNormal(render_data_context& rend_data_ctx,
        ...
        void Disp(render_data_context& rend_data_ctx, cam_data& cam, DispType disp_type, bool reflect);
        void Disp(render_data_context& rend_data_ctx, cam_data& cam, RenderGroupX* rend_group, bool reflect);
        void DispMesh();
...
struct dx_glitter_struct {
    ...
    static_assert(sizeof(dx_glitter_struct::batch_data) == 0xB0, "\"dx_glitter_struct::batch_data\" struct should have a size of 0xB0");

    dx_vertex_pixel_shader shaders[2];
    p_dx_buffer buffer;
    p_dx_buffer index_buffer;
    p_dx_rasterizer_state rasterizer_states[2];
...
extern dx_glitter_struct*& dx_glitter_struct_data;
