...
static_assert(sizeof(font_info) == 0x48, "\"font_info\" struct should have a size of 0x48");
...
static_assert(sizeof(PrintWork) == 0x70, "\"PrintWork\" struct should have a size of 0x70");
