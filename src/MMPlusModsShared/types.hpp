...
static float_t(*get_delta_frame)() = (float_t(*)())0x00000001402B7370;
static float_t(*sub_1402B73B0)() = (float_t(*)())0x00000001402B73B0;
    ...
    struct stack_allocator {
        ...
        inline void* allocate(size_t size) {
            static void* (*prj__stack_allocator__allocate)(prj::stack_allocator * This, size_t size)
                = (void* (*)(prj::stack_allocator * This, size_t size))0x00000001401843A0;
