...
static_assert(sizeof(rob_chara_pv_data_item) == 0x14, "\"rob_chara_pv_data_item\" struct should have a size of 0x14");
...
static_assert(sizeof(rob_chara_item_equip_object) == 0x208, "\"rob_chara_item_equip_object\" struct should have a size of 0x208");
...
static_assert(sizeof(rob_chara) == 0x8118, "\"rob_chara\" struct should have a size of 0x8118");
...
extern rob_chara_bone_data* (FASTCALL* rob_chara_array_get_bone_data)(size_t rob_chr_smth, int32_t chara_id);
