...
static_assert(sizeof(auth_3d_data_struct) == 0xC9140, "\"auth_3d_data_struct\" struct should have a size of 0xC9140");

int32_t(FASTCALL* auth_3d_data_get_uid_by_name)(const char* name)
    = (int32_t(FASTCALL*)(const char* name))0x00000001402E19D0;
bool (FASTCALL* auth_3d_data_check_category_loaded)(const char* category_name)
    = (bool (FASTCALL*)(const char* category_name))0x00000001402E1C20;
void (FASTCALL* auth_3d_data_load_category)(const char* category_name)
    = (void (FASTCALL*)(const char* category_name))0x00000001402E1C10;
void (FASTCALL* auth_3d_data_unload_category)(const char* category_name)
    = (void (FASTCALL*)(const char* category_name))0x00000001402E1C30;

static auth_3d_data_struct* auth_3d_data = (auth_3d_data_struct*)0x00000001414AC050;
...
auth_3d_id::auth_3d_id(int32_t uid) : id() {
    ((auth_3d_id * (FASTCALL*)(auth_3d_id * This, int32_t uid))0x0000000152F20F10)(this, uid);
}

auth_3d_id::auth_3d_id(const char* name) : id() {
    ((auth_3d_id * (FASTCALL*)(auth_3d_id * This, int32_t uid))0x0000000152F20F10)(
...
void auth_3d_id::read_file() {
    ((void (FASTCALL*)(auth_3d_id * This))0x0000000152F8D6C0)(this);
}
...
void auth_3d_id::unload() {
    ((void (FASTCALL*)(auth_3d_id * This))0x0000000152F27730)(this);
}
