...
struct auth_3d_object_disp_data {
    ...
    texture_pattern_struct* texture_pattern_array_ptr;
    texture_pattern_struct texture_pattern_array[24];
    size_t texture_transform_count;
    size_t texture_transform_count_max;
    texture_transform_struct* texture_transform_struct_ptr;
...
struct auth_3d_object {
    ...
    int64_t field_338;
    auth_3d_object_disp_data disp_data;
    prj::string name;
    prj::string uid_name;
...
static_assert(sizeof(auth_3d_object) == 0xC40, "\"auth_3d_object\" struct should have a size of 0xC40");
...
struct auth_3d_object_hrc_disp_data {
    int32_t flags;
    mat4 mat;
    mdl::ObjFlags obj_flags;
...
struct auth_3d_object_hrc {
    auth_3d_object_hrc_disp_data disp_data;
...
static_assert(sizeof(auth_3d_object_hrc) == 0x178, "\"auth_3d_object_hrc\" struct should have a size of 0x178");
...
struct auth_3d {
    ...
    prj::vector<int32_t> object_list_total_object_num;
...
static_assert(sizeof(auth_3d) == 0xC90, "\"auth_3d\" struct should have a size of 0xC90");
