...
static_assert(sizeof(AetArgs) == 0x158, "\"AetArgs\" struct should have a size of 0x158");
...
static_assert(sizeof(aet_layout_data) == 0x70, "\"aet_layout_data\" struct should have a size of 0x70");
...
extern uint32_t(FASTCALL* aet_manager_init_aet_object)(AetArgs& args, uint32_t id);
...
extern void (FASTCALL* aet_manager_set_obj_play)(uint32_t id, bool value);
...
extern bool (FASTCALL* aet_manager_set_obj_frame_rate_control)(uint32_t id, FrameRateControl* value);
